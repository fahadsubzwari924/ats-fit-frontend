/** Centralized upgrade nudge copy (billing / premium funnel). */
export const UpgradePromptCopy = {
  ...
  resumePreviewBody:
    'Store multiple PDFs and switch between them for tailoring and ATS scoring without re-uploading each time.',
} as const;
